        ...
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
            ...
            <div className='w-full md:w-1/3'>
                ...
                <div className='flex gap-2'>
                    <input type="email" placeholder="Enter your email" className='p-2 rounded-md text-white bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500' />
                    <button className='py-2 px-4 rounded bg-blue-500 text-white'>Subscreibe</button>
                </div>
            </div>
        </div>
        <div className='text-center text-gray-500 py-4 mt-10 border-t border-gray-700 '>Copyright 2024 © GreatStack. All Right Reserved.</div>
    </div>
  )
}
